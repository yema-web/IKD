...
def parse_option():
    ...
    parser.add_argument('--margin_w', type=float, default=1, help='weight for hinge loss')
    parser.add_argument('--avg', type=float, default=1, help='weight for hinge loss weight')
